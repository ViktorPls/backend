...
const DATABASE = new sqlite3.Database(dbName, (error) => {
  ...
  const sql = 'CREATE TABLE IF NOT EXISTS users (id TEXT PRIMARY KEY NOT NULL, username TEXT NOT NULL, name TEXT, email TEXT UNIQUE NOT NULL, password TEXT NOT NULL)'
